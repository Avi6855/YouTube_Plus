...
import com.avinashpatil.app.youtube.util.DefaultTrackSelectorWithAudioQualitySupport
import com.avinashpatil.app.youtube.util.NowPlayingNotification
import com.avinashpatil.app.youtube.util.PauseableTimer
...
abstract class AbstractPlayerService : MediaLibraryService(), MediaLibrarySession.Callback {
    ...
    open var isAudioOnlyPlayer: Boolean = false
